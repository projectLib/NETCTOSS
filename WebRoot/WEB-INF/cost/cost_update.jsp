        ...
        <div id="main">            
            ...
            <form action="updateCost.do" method="" class="main_form">
                ...
                <div class="button_info clearfix">
                    ...
                    <input type="button" value="取消" class="btn_save" onclick="javascript:history.back(-4);"/>
                    <input type="button" value="取消" class="btn_save" onclick="location.href=document.referrer;"/>
