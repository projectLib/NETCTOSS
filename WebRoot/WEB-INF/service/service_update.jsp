    ...
    <body>
       ...
       <div id="navi">
        ...
        <div id="main">
            ...
            <form action="updateService.do" method="get" class="main_form">
                <!--必填项-->
                <div class="text_info clearfix"><span>业务账号ID：</span></div>
                <div class="input_info">
                    <input name="service_id" type="text" value="${service.service_id}" readonly class="readonly" />
                </div>
                ...
                <div class="input_info">
                    <select name="cost_id" class="width150">
                    	<c:forEach items="${costs}" var="c">
                    		<option value="${c.cost_id}" <c:if test="${c.cost_id==service.cost_id}">selected</c:if>>
                    		${c.name}
                    		</option>
                    	</c:forEach>
                    </select>
