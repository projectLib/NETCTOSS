...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">  
            ...
            <form action="accountUpdate.do" method="post" class="main_form">
                    <!--必填项-->
                    ...
                    <div class="input_info">
                        <input name="login_name" type="text" value="${account.login_name}" class="readonly"  />        
                        <!--                
                    ...
                    <input type="radio" name="gender" value="f" <c:if test="${account.gender=='f'}">selected</c:if> id="female"  />
                    <label for="female">女</label>
                    <input type="radio" name="gender" value="m"<c:if test="${account.gender=='m'}">selected</c:if>  />
